 ...
 * 
 * Connect Data Pin Of LED Ring TO D2
 * Connect Button Pin to D3 and GND
 * Connect Buzzer Positive to D9 and GND
 * 
 */
...
//  Serial.begin(9600);
  ...
  FastLED.setBrightness(10); // Adjust the brightness (0-255) as per your preference
  intro();
  delay(100);
  TurnOffAll();
  delay(1000);
